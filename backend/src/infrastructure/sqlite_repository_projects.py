...
class DramaRepositoryProjectMixin:
    ...
    def create_drama_with_task(self, payload: ProjectCreate) -> tuple[dict[str, Any], dict[str, Any]]:
        ...
        drama = ShortDrama(
            ...
            episode_count=values.get("episode_count", 25),
            enable_web_search=bool(values.get("enable_web_search", False)),
            expanded_script_min_chars=values.get("expanded_script_min_chars", 5_000),
            expanded_script_max_chars=values.get("expanded_script_max_chars", 10_000),
            shot_script_max_chars=values.get("shot_script_max_chars", 400),
