...
CREATE TABLE IF NOT EXISTS short_dramas (
 id TEXT PRIMARY KEY, name TEXT NOT NULL, script TEXT NOT NULL, expanded_script TEXT NOT NULL DEFAULT '', ratio TEXT NOT NULL, style TEXT NOT NULL, theme TEXT NOT NULL, language_model TEXT NOT NULL, multimodal_model TEXT NOT NULL, video_model TEXT NOT NULL DEFAULT 'doubao-seedance-2.0', episode_count INTEGER NOT NULL DEFAULT 15, enable_web_search INTEGER NOT NULL DEFAULT 0, expanded_script_min_chars INTEGER NOT NULL DEFAULT 5000, expanded_script_max_chars INTEGER NOT NULL DEFAULT 10000, shot_script_max_chars INTEGER NOT NULL DEFAULT 400, resolution TEXT NOT NULL DEFAULT '720p', video_public_prompt TEXT NOT NULL DEFAULT '', asset_public_prompts_json TEXT NOT NULL DEFAULT '{}', shot_constraints_json TEXT NOT NULL DEFAULT '{}', status TEXT NOT NULL, shots_json TEXT NOT NULL DEFAULT '[]', assets_json TEXT NOT NULL DEFAULT '[]', historical_videos_json TEXT NOT NULL DEFAULT '[]', created_at TEXT NOT NULL, updated_at TEXT NOT NULL
);
